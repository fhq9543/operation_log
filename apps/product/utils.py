...
from .serializers import ProductRecordSerializer
...
def product_record_get(request):
    logs = ProductRecord.objects.all()
    ...
    serializer = ProductRecordSerializer(logs, many=True)
